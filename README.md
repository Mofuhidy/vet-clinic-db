...
**Vet Clinic DB** is a beginner PostgreSql project where I created a database and inserted date to tables.
...
his repository includes files with plain SQL that can be used to recreate a database:
